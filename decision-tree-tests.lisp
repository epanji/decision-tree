...
(defun test-criteria-decision-all ()
  ...
  (let ((decision-tree (decision-tree "test"))
    ...
    (format t "------------------------------------------------------------------------------------------------------------~%")
    (format t "(criteria-to-decision-in-tree nil d1 c2) => ~s~%" (criteria-to-decision-in-tree nil d1 c2))
    (format t "------------------------------------------------------------------------------------------------------------~%")
...
(defun test-answer-response ()
  (let ((decision-tree (decision-tree "test"))
    ...
    (format t "------------------------------------------------------------------------------------------------------------~%")
    (format t ";;~%;; test avoiding miss behavior when answer repeated~%;;~%")
    (setf (temporary-relations decision-tree)
          '(("d-1" "c-1" "c-2" "c-3")
            ("d-2" "c-2" "c-3")
            ("d-3" "c-2")
            ("d-4" "c-3"))
          (temporary-records decision-tree) '())
    (format t "(decision-from-answers decision-tree '((\"c-2\" . t) (\"c-2\" . t) (\"c-3\" . nil))) => ~s~%"
            (decision-from-answers decision-tree '(("c-2" . t) ("c-2" . t) ("c-3" . nil))))
    (setf (temporary-relations decision-tree)
          '(("d-1" "c-1" "c-2" "c-3")
            ("d-2" "c-2" "c-3")
            ("d-3" "c-2")
            ("d-4" "c-3"))
          (temporary-records decision-tree) '())
    (format t "(decision-from-answers \"test\" '((\"c-2\" . t) (\"c-3\" . nil) (\"c-3\" . nil))) => ~s~%"
            (decision-from-answers "test" '(("c-2" . t) ("c-3" . nil) ("c-3" . nil))))
    (format t "------------------------------------------------------------------------------------------------------------~%")
    (remove-decision-tree "test")))
